...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="wyxShareIconController.do?doUpdate" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="siSrc" name="siSrc" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${wyxShareIconPage.siSrc}'/>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="siOrder" name="siOrder" type="text" style="width: 150px" class="inputxt"  datatype="n"  ignore="ignore"  value='${wyxShareIconPage.siOrder}'/>
							<span class="Validform_checktip"></span>
