...
@Service("wyxShareTypeService")
@Transactional
public class WyxShareTypeServiceImpl extends CommonServiceImpl implements WyxShareTypeServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(WyxShareTypeEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(WyxShareTypeEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(WyxShareTypeEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(WyxShareTypeEntity t){
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("wyx_share_type",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
